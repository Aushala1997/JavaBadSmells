...
public class Reflection {
    ...
    public static void main(String[] args) {
        ...
        // Getting the class Object for ReflectionTest
        ...
        // Get the super class for ReflectionTest
        ...
        try {
            ...
            constructor = reflectClass.getConstructor(new Class[] { EmenyPlayer.class });
        ...
        EmenyPlayer oppent = null;

        ReflectionTest player = null;

        try {

            // Create a ReflectionTest object by calling newInstance

            oppent = (EmenyPlayer) constructor.newInstance(oppent);
        ...
        oppent.setName("Xt-1000");
        System.out.println("EnemyShip Name: " + oppent.getName());
        ...
        try {
            ...
            EmenyPlayer oppentPrivate = player.DominoEnemyplace(oppent);

            // Define the private field you want to access
            // I can access any field with just its name dynamically

            privateStringName = ReflectionTest.class.getDeclaredField("Auhsala");
            ...
            String valueOfName = (String) privateStringName.get(oppentPrivate);

            System.out.println("Your Oppents Name: " + valueOfName);

            String methodName = "getPrivate";

            Method privateMethod = ReflectionTest.class.getDeclaredMethod(methodName, null);
            ...
            String privateReturnVal = (String) privateMethod.invoke(oppentPrivate, null);

            System.out.println("Your Oppents Name: " + privateReturnVal);
            ...
            privateMethod = ReflectionTest.class.getDeclaredMethod("getOtherPrivate", methodParameters);
            ...
            privateReturnVal = (String) privateMethod.invoke(oppentPrivate, params);
