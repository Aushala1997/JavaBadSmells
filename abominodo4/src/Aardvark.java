...
public class Aardvark {
  ...
  private static final String errorMssgScrs = "Something went wrong saving scores";
  private static final String errorMssgDio = "something went wrong generating dominoes";
  int mode = -1;
  int cf;
  int score;
  long startTime;
  ...
  private void generateDominoes() {
    ...
    if (count != 28) {
      System.out.println(errorMssgDio);
      System.exit(0);
    }
  }
  ...
  public void run() {
    ...
    while (_$_ != ZERO) {
      ...
      switch (_$_) {
        ...
        case 1: {
          setTheGameMode(pf, io);
        }
          break;
        case 2: {
          String h4 = "High Scores";
          String u4 = h4.replace(".", "=");
          ...
          if (!(f.exists() && f.isFile() && f.canRead())) {
            ...
            try {
              ...
              System.out.println(errorMssgScrs);
            } finally {
        ...
        case 3: {
          ...
          try {
            ...
            System.out.println("Here are the rule");
          }
  ...
  public void exitingGame(List<Domino> _d) {
    if (_d == null) {
  ...
  public void setTheGameMode(PictureFrame pf, IOSpecialist io) {
    System.out.println();
    ...
    generateGuesses();
    collateGuessGrid();
    intailStartOfGame(pf, io);

  }

  public void setRolls(int c2) {
    switch (c2) {
      case 1:
        generateDominoes();
  ...
  public void intailStartOfGame(PictureFrame pf, IOSpecialist io) {
    mode = 1;
    cf = 0;
    score = 0;
    startTime = System.currentTimeMillis();
    pf.PictureFramed(this);
    pf.dp.repaint();
    int c3 = -7;
    while (c3 != ZERO) {
      System.out.println();
      String h5 = "Play menu";
      String u5 = h5.replace(".", "=");
  ...
  private void settingColumn(PictureFrame pf, IOSpecialist io) {
  ...
  private void settingDomino(PictureFrame pf, IOSpecialist io) {
  ...
  private void cheatingMode(PictureFrame pf, IOSpecialist io) {
    System.out.println();
    String h8 = "So you want to cheat, huh?";
    String u8 = h8.replace(".", "=");
    ...
    while (yy < 0 || yy > 4) {
      try {
        ...
        System.out.println("Please do buy");
      }
    }
    switch (yy) {
      case 0:
